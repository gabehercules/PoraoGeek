        ...
        <div className="flex flex-col gap-8 w-[768px] pt-10">
          <div>
            ...
            <p className="text-zinc-400">
              O Porão se compromete sempre, a proporcionar um nível de conteúdo
              de alta qualidade, visando mater nossa comunidade sempre engajada
              e entretida, além de proporcionar experiências únicas e valorozas.
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex w-fit rounded-md border border-zinc-800 overflow-hidden mt-4">
                <p className="flex items-center justify-center text-sm py-2 px-3 pointer-events-none bg-darker-bg">
                  Chave pix
                </p>
                <span className="flex gap-1 items-center p-1 text-zinc-500 bg-zinc-900">
                  ...
                  <button
                    ...
                    className="w-6 h-6 flex items-center justify-center p-[2px] rounded hover:bg-darker-bg hover:text-brand-green duration-300 transition-colors"
                  >
                    {copied ? (
                      <>
                        <Check width={18} height={18} />
                        <span className="text-xs absolute p-1 bg-darker-bg rounded translate-x-12">
                          Copiado!
                        </span>
                      </>
                    ) : (
