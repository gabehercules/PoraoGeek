        ...
        <div className="flex gap-4">
          <div className="p-4 rounded-lg bg-brand-green/10">
            ...
            <p className="text-sm">
              ...
              notícias, reviews, análises, críticas, opiniões e muito mais e com
              uma experiência focada no consumo do conteúdo.{" "}
          ...
          <div className="p-4 rounded-lg bg-orange-500/10">
            ...
            <p className="text-sm">
              ...
              independência de ADS precisamos da sua ajuda. Em breve, nossa
              campanha no Apoia.se estará no ar onde você poderá ajudar o Porão
              a continuar operando e ainda ganhará brindes e recompensas
              exclusivas.
            </p>
          </div>
        </div>
